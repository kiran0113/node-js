...
const B2CTransactionLimits: React.FC<any> = ({
...
// setComplianceFields****************
  ...
  const GetReceiverInfo = (
    ...
    PaymentSettingsServices.getReceiverInformation(Number(partnerid), "B2C", 1)
      .then((res) => {
        ...
        <>
          <div className="row ">
            <div className="col-md-11">
              <h2>
              Choose all the information that you  require about the consumer “receiving” the payment
              </h2>
            </div>
...
export default B2CTransactionLimits;
